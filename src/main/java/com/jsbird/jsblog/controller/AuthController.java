...
import com.jsbird.jsblog.model.LoginDto;
import com.jsbird.jsblog.model.TokenDto;
import com.jsbird.jsblog.utiliy.SecurityUtil;
import com.jsbird.jsblog.utiliy.jwt.JwtFilter;
...
public class AuthController {
    ...
    public ResponseEntity<TokenDto> authorize(LoginDto loginDto) {
        log.info(SecurityUtil.getCurrentUsername().orElse(""));
